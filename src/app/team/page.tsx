...
const { title: TITLE, description: DESCRIPTION } = getCopy("team").meta;
    ...
    <>
      ...
      <Section className="border-b border-border">
        <div className="grid gap-12 lg:grid-cols-[1.15fr_1fr] lg:gap-16">
          <div className="flex max-w-[62ch] flex-col gap-5">
            <p className="text-eyebrow uppercase text-accent">{copy.about.eyebrow}</p>
            ...
            <div className="mt-2 flex flex-col gap-4 text-body text-text-muted">
              <p>{fill(copy.about.fsBody, { organiser: site.competition.organiser })}</p>
              <p>
                {fill(copy.about.kufsBody, {
          ...
          <aside className="flex flex-col gap-4 self-start rounded-lg border border-border bg-surface p-7">
            <h2 className="text-h4 text-text">{copy.about.asideHeading}</h2>
      ...
      <Section labelledBy="roster-heading">
        ...
        <div className="mt-12">
          <h3 className="border-b border-border pb-3 text-h3 text-text">
            {copy.roster.operationsHeading}
          </h3>
          <p className="mt-4 max-w-[62ch] text-body text-text-muted">
            {copy.roster.operationsBody}
          </p>
        ...
        <div className="mt-16">
          <h3 className="border-b border-border pb-3 text-h3 text-text">
            {copy.roster.engineeringHeading}
          </h3>
          <p className="mt-4 max-w-[62ch] text-body text-text-muted">
            {copy.roster.engineeringBody}
          </p>
        ...
        {site.facultyAdvisor ? (
          <div className="mt-16 rounded-lg border border-border bg-surface p-7">
            <h3 className="text-h4 text-text">{copy.roster.advisorHeading}</h3>
      ...
      <Section tight className="border-t border-border">
        <div className="flex flex-col items-start gap-6 rounded-lg border border-border bg-surface p-8 lg:flex-row lg:items-center lg:justify-between lg:p-10">
          ...
          <Button href={nav.cta.join.href} size="lg" className="shrink-0">
            {nav.cta.join.label}
          </Button>
        </div>
      </Section>
